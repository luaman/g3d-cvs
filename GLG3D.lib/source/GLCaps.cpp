...
void GLCaps::loadExtensions(Log* debugLog) {
    ...
    LOAD_EXTENSION(glStencilOpSeparateATI, PFNGLSTENCILOPSEPARATEATIPROC);
        ...
        LOAD_EXTENSION(glXJoinSwapGroupNV, PFNGLXJOINSWAPGROUPNVPROC);
        LOAD_EXTENSION(glXBindSwapBarrierNV, PFNGLXBINDSWAPBARRIERNVPROC);
        LOAD_EXTENSION(glXQuerySwapGroupNV, PFNXQUERYSWAPGROUPNVPROC);
        LOAD_EXTENSION(glXQueryMaxSwapGroupsNV, PFNXQUERYMAXSWAPGROUPSNVPROC);
        LOAD_EXTENSION(glXQueryFrameCountNV, PFNGLXQUERYFRAMECOUNTNVPROC);
        LOAD_EXTENSION(glXResetFrameCountNV, PFNGLXRESETFRAMECOUNTNVPROC);

        LOAD_EXTENSION(glXCreateGLXPbufferSGIX, PFNGLXCREATEGLXPBUFFERSGIXPROC);
        LOAD_EXTENSION(glXDestroyGLXPbufferSGIX, PFNGLXDESTROYGLXPBUFFERSGIXPROC);
        LOAD_EXTENSION(glXQueryGLXPbufferSGIX, PFNGLXQUERYGLXPBUFFERSGIXPROC);
        LOAD_EXTENSION(glXChooseFBConfigSGIX, PFNGLXCHOOSEFBCONFIGSGIXPROC);
        LOAD_EXTENSION(glXCreateContextWithConfigSGIX, PFNGLXCREATECONTEXTWITHCONFIGSGIXPROC);
    #endif
